@if ($paginator->hasPages())
    ...
    <div class="flex items-center">
        <div class="flex-1 text-gray-600 font-semibold">
        Showing {{$paginator->perPage()}} of {{$paginator->total()}}
        </div>
            ...
            @else
                <li class="mr-1">
                    <a class="block px-3 py-2 border border-gray-400 rounded hover:bg-white"
                       href="{{ $paginator->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')">Prev</a>
                </li>
            @endif
